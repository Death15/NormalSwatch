...
local function run(msg, matches)
  ...
  if matches[1] == 'modadd' and not matches[2] then
   ...
   if matches[1] == 'add' and matches[2] == 'vip' then
    if is_group(msg) then
  ...
  if matches[1] == 'rem' and matches[2] == 'vip' then
    ...
    if matches[1] == 'chat_delete_photo' then
      ...
      if group_photo_lock == 'yes' then
        ...
        if picprotectionredis then 
          if tonumber(picprotectionredis) == 4 and not is_leader(msg) then 
            kick_user(msg.from.id, msg.to.id)
          end
          if tonumber(picprotectionredis) ==  8 and not is_leader(msg) then 
  ...
  --[[if matches[1] == 'public' then
    ...
    if matches[1] == 'leader' then
      ...
      return "Group owner is ["..group_leader..']'
    end
